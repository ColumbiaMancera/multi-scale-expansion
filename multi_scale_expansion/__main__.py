...
if __name__ == "__main__": 
    ...
    criterion, optimizer_ft, exp_lr_scheduler = get_train_loss_needs(model_ft, lr=0.001, momentum=0.9, step_size=7, gamma=0.1)

    # Train and evaluate model 
    model_ft, train_losses, train_accuracies, val_losses, val_accuracies = train_model(dataset_sizes, dataloaders, 
                        model_ft, criterion, optimizer_ft, exp_lr_scheduler, num_epochs=16)
